...
cp "tmux.bill.conf" "$HOME/.tmux.conf"
...
cp "bill_configs.vim" "$HOME/.vim_runtime/my_configs.vim"

# Install Vundle, vim's plugin manager
# Ref: https://github.com/VundleVim/Vundle.vim
git clone "https://github.com/VundleVim/Vundle.vim.git" "$HOME/.vim_runtime/bundle/Vundle.vim"
